...
<div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Goodreads </a>
            </div>
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li><a href="{{url('/profile/'.Auth::user()->id.'/	settings')}}"><i class="fa fa-gear fa-fw"></i> Settings</a>
                        </li>
                        <li class="divider"></li>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="" href="{{url('/admin')}}"><i class="fa fa-users" aria-hidden="true"></i>Users</a>
                    </li>
                    <li>
                        <a href="{{url('admin/actions')}}"><i class="fa fa-user-plus" aria-hidden="true"></i>Users' Actions</a>
                    </li>
					<li>
                        <a class="active-menu" href="{{url('admin/books')}}"><i class="fa fa-book" aria-hidden="true"></i>Books</a>
                    </li>
                    <li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Users' actions
                            <a href="{{url('admin/books/create-new-book')}}" class="btn btn-success pull-right">Create a new book</a>
                        </h1>
                    </div>
                </div>
				    		...
				    		<tbody>
								...
								@foreach($books as $book)
									<tr>
										...
										<td><a href="{{url('admin/delete/'.$users->id)}}" class="btn btn-danger">Delete</a></td> --}}
									</tr>	
								@endforeach
				  			</tbody>
